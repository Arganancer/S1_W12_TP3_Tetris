...
namespace TetrisDotnet.Code.UI
{
	...
	public static class AssetPool
	{
		...
		public static Texture BackDropTexture { get; } = new Texture("Assets/Art/background_img.png");
		...
		public static Texture DrawGridBackgroundTexture { get; } = new Texture("Assets/Art/gridbox_Frame.png");
